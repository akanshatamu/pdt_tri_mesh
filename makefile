...
all:$(BIN)Tricall_Pre_Mesh_Gen

trilibrary: $(BIN)Tricall_Pre_Mesh_Gen.o

$(BIN)Tricall_Pre_Mesh_Gen: $(BIN)Tricall_Pre_Mesh_Gen.cc $(BIN)Tricall_Utility.cc $(BIN)Data_Transfer_Object.cc $(BIN)triangle.o
	$(MPICC) $(CSWITCHES) -o $(BIN)Tricall_Pre_Mesh_Gen $(SRC)Tricall_Pre_Mesh_Gen.cc $(SRC)Tricall_Utility.cc $(SRC)Data_Transfer_Object.cc \
		$(BIN)triangle.o -lm
	
$(BIN)Tricall_Pre_Mesh_Gen.o: $(SRC)Tricall_Pre_Mesh_Gen.cc $(SRC)Tricall_Pre_Mesh_Gen.h $(SRC)Tricall_Utility.cc $(SRC)Tricall_Utility.h $(SRC)Data_Transfer_Object.cc $(SRC)Data_Transfer_Object.h $(BIN)triangle.o
	$(MPICC) $(CSWITCHES) $(TRILIBDEFS) -c -o $(BIN)Tricall_Pre_Mesh_Gen.o \
		$(SRC)Tricall_Pre_Mesh_Gen.cc $(SRC)Tricall_Utility.cc $(SRC)Data_Transfer_Object.cc		

distclean:
	$(RM) $(BIN)Tricall_Pre_Mesh_Gen
